...
<section class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-100 dark:border-slate-700/80 card-shadow hover:scale-[1.01] transition-all duration-300">
        ...
        <h3 class="text-4xl font-extrabold text-navy-800 dark:text-slate-100 leading-none">{{ \App\Models\User::count() ?? 0 }}</h3>
    ...
    <div class="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-100 dark:border-slate-700/80 card-shadow hover:scale-[1.01] transition-all duration-300">
        ...
        <h3 class="text-4xl font-extrabold text-navy-800 dark:text-slate-100 leading-none">6</h3>
        <p class="text-slate-400 dark:text-slate-400 text-sm font-semibold mt-1">Alertas de Vencimiento</p>
        <div class="border-t border-slate-100 dark:border-slate-700/80 mt-5 pt-3">
            <a href="#" class="text-emerald-500 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 text-sm font-bold flex items-center gap-1">
    ...
    <div class="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-100 dark:border-slate-700/80 card-shadow hover:scale-[1.01] transition-all duration-300">
        ...
        <h3 class="text-4xl font-extrabold text-navy-800 dark:text-slate-100 leading-none">1</h3>
        <p class="text-slate-400 dark:text-slate-400 text-sm font-semibold mt-1">Roles Definidos</p>
        <div class="border-t border-slate-100 dark:border-slate-700/80 mt-5 pt-3">
            <a href="#" class="text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 text-sm font-bold flex items-center gap-1">
