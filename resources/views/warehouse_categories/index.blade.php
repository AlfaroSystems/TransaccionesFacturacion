                    ...
                    <tr class="group hover:scale-[1.005] hover:shadow-md transition-all duration-200">
                        ...
                        <td class="px-6 py-4 bg-white rounded-r-2xl border-r border-y border-slate-100 text-center">
                            <div class="flex justify-center gap-2">
                                ...
                                <button type="button" onclick="confirmDelete('{{ route('warehouse_categories.destroy', $category->id) }}', '{{ $category->name }}')" class="p-2 text-rose-600 bg-rose-50 hover:bg-rose-100 border border-rose-100/50 rounded-xl transition-all" title="Eliminar Categoría">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
