...
<div class="w-full space-y-6 animate-fade-in duration-300">
    ...
    <!-- Mensajes de Estado -->
    @if(session('success'))
        <div class="bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 px-5 py-4 rounded-2xl font-semibold text-sm flex items-center gap-3 shadow-sm">
    ...
    @if(session('error'))
        <div class="bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800 text-rose-700 dark:text-rose-300 px-5 py-4 rounded-2xl font-semibold text-sm flex items-center gap-3 shadow-sm">
