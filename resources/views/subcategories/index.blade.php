                    ...
                    <tr class="group hover:scale-[1.002] hover:shadow-md transition-all duration-200">
                        ...
                        <td class="py-4 px-6 bg-white rounded-r-2xl border-r border-y border-slate-100 text-center">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <button type="button" onclick="confirmDelete('{{ route('subcategories.destroy', $subCategory) }}', 'Subcategoría {{ $subCategory->name }}')" class="p-2 rounded-lg bg-rose-50 text-rose-600 hover:bg-rose-100 font-semibold text-xs transition-all" title="Eliminar">
