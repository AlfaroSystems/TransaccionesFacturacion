        ...
        <div class="w-full md:w-3/5 p-8 flex flex-col justify-between">
            ...
            <div class="w-full max-w-sm mx-auto my-auto py-4">
                ...
                <div class="flex border-b border-gray-100 mb-8">
                    <button onclick="window.location.href='{{ route('login') }}'" class="flex-1 text-center pb-3 text-sm font-semibold text-gray-400 border-b-2 border-transparent hover:text-gray-600 transition-all">
                        Iniciar sesión
                    </button>
                ...
                <!-- Info Message -->
                <div class="mb-6 text-xs text-gray-500 font-medium leading-relaxed bg-[#edf9f6]/70 p-4 rounded-2xl border border-customTeal-100">
