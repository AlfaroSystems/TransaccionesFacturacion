            ...
            <div class="w-full max-w-sm mx-auto my-auto py-4">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div class="flex items-center ml-4">
                        <input id="remember_me" type="checkbox" class="rounded border-gray-300 dark:border-slate-600 dark:bg-slate-900 text-customTeal-500 shadow-sm focus:ring-customTeal-400" name="remember">
                    ...
                    <div class="flex items-center justify-between pt-2">
                        @if (Route::has('password.request'))
                            <a class="text-xs text-customTeal-700 dark:text-customTeal-400 hover:text-customTeal-500 hover:underline font-bold transition-all" href="{{ route('password.request') }}">
