    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div class="flex flex-wrap items-center gap-3 w-full md:w-auto">
            ...
            @elseif($purchase_order->status === 'issued')
                @can('purchases.crear')
                    <a href="{{ route('purchases.create', ['id_purchase_order' => $purchase_order->id_purchase_order]) }}" class="px-5 py-2.5 rounded-full bg-teal-600 hover:bg-teal-700 text-white font-extrabold text-xs transition-all flex items-center gap-2 shadow-md" title="Registrar Factura / Recepción de Compra">
